...
public class RenderPosition {
    ...
    public float get() {
        return Easing.ease(1.0f - Easing.toDelta(startTime, UltraByte.MODULE_MANAGER.getModule(RendersModule.class).duration.getValue().intValue()), Easing.Method.EASE_IN_CUBIC);
    }
}
