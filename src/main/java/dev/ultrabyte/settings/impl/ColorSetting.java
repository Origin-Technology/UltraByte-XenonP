...
public class ColorSetting extends Setting {
    ...
    public java.awt.Color getColor() {
        if (isSync()) {
            ...
            if (isRainbow()) {
                if (this == UltraByte.MODULE_MANAGER.getModule(ColorModule.class).color) return ColorUtils.getRainbow(255);
                return ColorUtils.getRainbow(getAlpha());
            } else {
                if (this == UltraByte.MODULE_MANAGER.getModule(ColorModule.class).color) return ColorUtils.getColor(value.getColor(), 255);
