package dev.ultrabyte.settings.impl;
...
public class NumberSetting extends Setting {
    ...
    public void setValue(Number value) {
        switch (getType()) {
            case LONG -> this.value = MathHelper.clamp(value.longValue(), minimum.longValue(), maximum.longValue());
            case DOUBLE -> this.value = MathHelper.clamp(value.doubleValue(), minimum.doubleValue(), maximum.doubleValue());
            case FLOAT -> this.value = MathHelper.clamp(value.floatValue(), minimum.floatValue(), maximum.floatValue());
            default -> this.value = MathHelper.clamp(value.intValue(), minimum.intValue(), maximum.intValue());
        }
        UltraByte.EVENT_HANDLER.post(new SettingChangeEvent(this));
    }
