...
import dev.ultrabyte.mixins.accessors.*;
...
public class ShaderManager implements IMinecraft {
    ...
    public void render(int renderMode, float opacity) {
        PostEffectProcessor shader = mc.getShaderLoader().loadPostEffect(Identifier.of(UltraByte.MOD_ID, "outline"), DefaultFramebufferSet.MAIN_ONLY);
