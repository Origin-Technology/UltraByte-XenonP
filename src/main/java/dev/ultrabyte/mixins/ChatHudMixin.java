...
import dev.ultrabyte.utils.text.CustomFormatting;
                        ...
                        if (t < 200 || focused) {
                            ...
                            if (u > 3) {
                                ...
                                if ((!module.isToggled() || !module.noIndicators.getValue()) && messageIndicator != null) {
                                    int z = ((IChatHudLineVisible) (Object) visible).ultrabyte$isClientMessage() ? ColorUtils.getGlobalColor().getRGB() : messageIndicator.indicatorColor() | u << 24;
