...
public class NoSlowModule extends Module {
    ...
    public void onUpdateMovement(UpdateMovementEvent event) {
        ...
        if (mc.player.getActiveHand() == Hand.OFF_HAND) {
            ...
            mc.getNetworkHandler().sendPacket(new UpdateSelectedSlotC2SPacket((int) (mc.player.getInventory().selectedSlot % 7.6 + 1.4)));
            mc.getNetworkHandler().sendPacket(new UpdateSelectedSlotC2SPacket((int) (mc.player.getInventory().selectedSlot % 6.1 + 2.9)));
            mc.getNetworkHandler().sendPacket(new UpdateSelectedSlotC2SPacket(mc.player.getInventory().selectedSlot));
        } else {
