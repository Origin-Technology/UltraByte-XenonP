...
public class RPCModule extends Module {
    ...
    public void onEnable() {
        ...
        rpc.setStart(UltraByte.UPTIME/1000);
        setImage();
    ...
    private void setImage() {
        rpc.setLargeImage(getImageIndex() + "", UltraByte.MOD_NAME + " " + UltraByte.MOD_VERSION);
    }
