...
import dev.ultrabyte.utils.minecraft.*;
...
public class AutoBedModule extends Module {
    ...
    private void placeBed(BlockPos pos, Direction direction, Direction rotation) {
        if(rotate.getValue()) UltraByte.ROTATION_MANAGER.rotate(RotationUtils.getRotations(pos.toCenterPos()), this);

        UltraByte.ROTATION_MANAGER.packetRotate(RotationUtils.getRotations(rotation));
