package dev.ultrabyte.gui;

import dev.ultrabyte.UltraByte;
import dev.ultrabyte.gui.api.Button;
import dev.ultrabyte.gui.api.DescriptionFrame;
...
public class ClickGuiScreen extends Screen {
    ...
    public void renderBackground(DrawContext context, int mouseX, int mouseY, float delta) {
        if(UltraByte.MODULE_MANAGER.getModule(ClickGuiModule.class).blur.getValue()) applyBlur();
    ...
    public void close() {
        super.close();
        UltraByte.MODULE_MANAGER.getModule(ClickGuiModule.class).setToggled(false);
    }
    ...
    public static Color getButtonColor(int index, int alpha) {
        Color color = UltraByte.MODULE_MANAGER.getModule(ClickGuiModule.class).isRainbow() ? ColorUtils.getOffsetRainbow(index*10L) : UltraByte.MODULE_MANAGER.getModule(ClickGuiModule.class).color.getColor();
