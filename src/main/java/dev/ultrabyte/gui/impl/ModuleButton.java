    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if(open) {
            for(Button button : buttons) {
                ...
                if(button.isHovering(mouseX, mouseY) && UltraByte.CLICK_GUI.getDescriptionFrame().getDescription().isEmpty()) UltraByte.CLICK_GUI.getDescriptionFrame().setDescription(button.getDescription());
            }
        }
    }
