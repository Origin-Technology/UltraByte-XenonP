...
import dev.ultrabyte.modules.impl.core.ColorModule;
...
public class ColorButton extends Button {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if(open) {
            ...
            UltraByte.FONT_MANAGER.drawTextWithShadow(context, "Copy", getX() + getPadding() + (getWidth()/4) - 1 - UltraByte.FONT_MANAGER.getWidth("Copy")/2, getY() + offset + 2, Color.WHITE);
            ...
            UltraByte.FONT_MANAGER.drawTextWithShadow(context, "Paste", getX() + (getWidth()/2) + (getWidth()/4) - 1 - UltraByte.FONT_MANAGER.getWidth("Paste")/2, getY() + offset + 2, Color.WHITE);
            ...
            UltraByte.FONT_MANAGER.drawTextWithShadow(context, "Sync", getX() + (getWidth()/2) - UltraByte.FONT_MANAGER.getWidth("Sync")/2, getY() + offset + 2, Color.WHITE);
            ...
            UltraByte.FONT_MANAGER.drawTextWithShadow(context, "Rainbow", getX() + (getWidth()/2) - UltraByte.FONT_MANAGER.getWidth("Rainbow")/2, getY() + offset + 2, Color.WHITE);
    ...
    public void mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if(button == 0) {
            ...
            if(hoveringCopy) {
                UltraByte.CLICK_GUI.setColorClipboard(setting.getValue().getColor());
                playClickSound();
            }
            if(hoveringPaste && UltraByte.CLICK_GUI.getColorClipboard() != null) {
                setting.setColor(UltraByte.CLICK_GUI.getColorClipboard());
                hsb = Color.RGBtoHSB(setting.getColor().getRed(), setting.getColor().getGreen(), setting.getColor().getBlue(), null);
                playClickSound();
            }
            if(setting != UltraByte.MODULE_MANAGER.getModule(ColorModule.class).color && hoveringSync) {
