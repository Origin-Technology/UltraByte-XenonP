...
public class    MacroManager implements IMinecraft {
    ...
    public void onKeyInput(KeyInputEvent event) {
        ...
        for (String key : macros.keySet()) {
            ...
            if (key == null) {
                UltraByte.CHAT_MANAGER.error("An error happened while executing the " + ChatUtils.getPrimary() + KeyboardUtils.getKeyName(value) + ChatUtils.getSecondary() + " macro.");
                continue;
            }
            ...
            for (String str : split) {
                if (str.startsWith("/")) {
                    ...
                    if (str.startsWith(UltraByte.COMMAND_MANAGER.getPrefix())) {
                        UltraByte.COMMAND_MANAGER.execute(str);
                    } else {
