...
import dev.opan.mixins.accessors.ChatHudAccessor;
...
public class ChatManager implements IMinecraft {
    ...
    private void addTextMessage(Text message, String identifier) {
        ...
        ((IChatHudLine) (Object) line).opan$setClientMessage(true);
        ((IChatHudLine) (Object) line).opan$setClientIdentifier(identifier);
        ...
        for (int j = 0; j < list.size(); ++j) {
            ...
            ((IChatHudLineVisible) (Object) visible).opan$setClientMessage(true);
            ((IChatHudLineVisible) (Object) visible).opan$setClientIdentifier(identifier);
    ...
    public static void deleteMessage(String identifier) {
        try {
            ...
            for (ChatHudLine message : ((ChatHudAccessor) mc.inGameHud.getChatHud()).getMessages()) {
                if (!((IChatHudLine) (Object) message).opan$isClientMessage() || ((IChatHudLine) (Object) message).opan$getClientIdentifier().isEmpty()) continue;
                if (((IChatHudLine) (Object) message).opan$getClientIdentifier().equals(identifier)) {
            ...
            for (ChatHudLine.Visible message : ((ChatHudAccessor) mc.inGameHud.getChatHud()).getVisibleMessages()) {
                if (!((IChatHudLineVisible) (Object) message).opan$isClientMessage() || ((IChatHudLineVisible) (Object) message).opan$getClientIdentifier().isEmpty()) continue;
                if (((IChatHudLineVisible) (Object) message).opan$getClientIdentifier().equals(identifier)) {
