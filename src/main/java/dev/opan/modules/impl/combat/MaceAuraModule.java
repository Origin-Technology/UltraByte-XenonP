...
import dev.opan.mixins.accessors.ClientPlayerInteractionManagerAccessor;
...
public class MaceAuraModule extends Module {
    ...
    public void onPlayerUpdate(PlayerUpdateEvent event) {
        ...
        if(rotate.getValue()) UltraByte.ROTATION_MANAGER.rotate(RotationUtils.getRotations(target), this);
