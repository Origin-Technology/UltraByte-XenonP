...
@RegisterModule(name = "AutoElytra", description = "Automatically equips the best armor.", category = Module.Category.MISCELLANEOUS)
public class AutoElytraModule extends Module {
    ...
    public void onKeyInput(KeyInputEvent event) {
        ...
        if(event.getKey() == 6 && !elytra.getValue() && !mc.player.isOnGround() && !EntityUtils.isInWeb(mc.player)) {
    ...
    public void onPlayerUpdate(PlayerUpdateEvent event) {
        ...
        if (ticks <= 0) {
            ...
            if (!(mc.player.getInventory().getStack(38).getItem() == Items.ELYTRA) || elytra.getValue()) update(EquipmentSlot.CHEST, 6);
