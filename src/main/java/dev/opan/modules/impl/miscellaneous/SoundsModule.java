...
public class SoundsModule extends Module {
    ...
    public void onTargetDeath(TargetDeathEvent event) {
        ...
        if(killSound.getValue()) FileUtils.playSound(new File(UltraByte.MOD_NAME + "/Client/" + killName.getValue()), killVolume.getValue().floatValue());
    }
    ...
    public void onAttackEntity(AttackEntityEvent event) {
        ...
        if(hitSound.getValue()) FileUtils.playSound(new File(UltraByte.MOD_NAME + "/Client/" + hitName.getValue()), hitVolume.getValue().floatValue());
