...
import dev.opan.events.impl.ChatInputEvent;
import dev.opan.events.impl.PlayerConnectEvent;
import dev.opan.events.impl.PlayerDisconnectEvent;
...
public class WelcomerModule extends Module {
    ...
    public void onPlayerConnect(PlayerConnectEvent event) {
        ...
        if(player != null && joins.getValue()) {
            if(clientside.getValue()) UltraByte.CHAT_MANAGER.message(Formatting.DARK_GRAY + "[" + Formatting.GREEN + (unicode.getValue() ? "»" : ">") + Formatting.DARK_GRAY + "] " + Formatting.GRAY + player.getName().getString());
    ...
    public void onPlayerDisconnect(PlayerDisconnectEvent event) {
        ...
        if(player != null && leaves.getValue()) {
            if(clientside.getValue()) UltraByte.CHAT_MANAGER.message(Formatting.DARK_GRAY + "[" + Formatting.RED + (unicode.getValue() ? "«" : "<")+ Formatting.DARK_GRAY + "] " + Formatting.GRAY + player.getName().getString());
