...
public class AccelerateModule extends Module {
    ...
    public void onPlayerMove(PlayerMoveEvent event) {
        if(getNull() || (UltraByte.MODULE_MANAGER.getModule(HoleSnapModule.class).isToggled() && UltraByte.MODULE_MANAGER.getModule(HoleSnapModule.class).hole != null) || UltraByte.MODULE_MANAGER.getModule(SpeedModule.class).isToggled()) return;
