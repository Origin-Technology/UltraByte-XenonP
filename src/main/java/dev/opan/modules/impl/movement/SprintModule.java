...
import dev.opan.mixins.accessors.ClientPlayerEntityAccessor;
...
public class SprintModule extends Module {
    ...
    public boolean shouldSprint() {
        ...
        if (mode.getValue().equalsIgnoreCase("Rage")) {
            ...
            if (mc.player.isUsingItem() && (!UltraByte.MODULE_MANAGER.getModule(NoSlowModule.class).isToggled() || !UltraByte.MODULE_MANAGER.getModule(NoSlowModule.class).items.getValue())) return false;
