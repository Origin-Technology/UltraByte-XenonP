...
import dev.opan.mixins.accessors.ItemRenderStateAccessor;
import dev.opan.mixins.accessors.ItemRendererAccessor;
import dev.opan.mixins.accessors.LayerRenderStateAccessor;
import dev.opan.modules.Module;
import dev.opan.modules.RegisterModule;
import dev.opan.modules.impl.miscellaneous.FakePlayerModule;
...
public class NameTagsModule extends Module {
    ...
    public BooleanSetting opanCheck = new BooleanSetting("opanCheck", "Adds an indicator next to the name of other users..", true);
