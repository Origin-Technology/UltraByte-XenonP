    ...
    public void onRenderWorld(RenderWorldEvent event) {
        ...
        for (Entity entity : mc.world.getEntities()) {
            ...
            if (entity instanceof LivingEntity livingEntity) {
                ...
                Color friendFill = flag ? ColorUtils.getColor(damageColor.getColor(), friendFillColor.getColor().getAlpha()) : (friendMode.getValue().equals("Default") ? UltraByte.FRIEND_MANAGER.getDefaultFriendColor(friendFillColor.getColor().getAlpha()) : friendFillColor.getColor());
                Color friendOutline = flag ? ColorUtils.getColor(damageColor.getColor(), friendOutlineColor.getColor().getAlpha()) : (friendMode.getValue().equals("Default") ? UltraByte.FRIEND_MANAGER.getDefaultFriendColor(friendOutlineColor.getColor().getAlpha()) : friendOutlineColor.getColor());
                Color fillColor = (livingEntity instanceof PlayerEntity player && UltraByte.FRIEND_MANAGER.contains(player.getName().getString()) && !friendMode.getValue().equals("Sync")) ? friendFill : flag ? ColorUtils.getColor(damageColor.getColor(), entityFillColor.getColor().getAlpha()) : entityFillColor.getColor();
                Color outlineColor = (livingEntity instanceof PlayerEntity player && UltraByte.FRIEND_MANAGER.contains(player.getName().getString()) && !friendMode.getValue().equals("Sync")) ? friendOutline : flag ? ColorUtils.getColor(damageColor.getColor(), entityOutlineColor.getColor().getAlpha()) : entityOutlineColor.getColor();
